/**
 * Virstack AI Web Chat UI Widget
 *
 * Build:
 *   esbuild virstack_ai_web_chat_ui.js \
 *     --bundle \
 *     --outfile=dist/virstack_ai_web_chat_ui.umd.js \
 *     --format=iife \
 *     --global-name=VirstackAIWebChatUIWidget \
 *     --platform=browser
 *
 * Usage (auto-init via data-* attributes):
 *   <script
 *     src="dist/virstack_ai_web_chat_ui.umd.js"
 *     data-virstack-widget
 *     data-primary-color="#D68B4B"
 *     data-secondary-color="#324A6D"
 *     data-server-url="https://your-api.example.com/chat"
 *     data-icon-url="https://example.com/avatar.jpg"
 *     data-button-size="64"
 *     data-title="My Assistant"
 *     data-status-text="Always here for you"
 *     data-placeholder="Ask me anything..."
 *     data-greeting-message="Hello! How can I help you today?"
 *     data-auto-open="true"
 *     data-auto-open-delay="800"
 *   ></script>
 *
 * Usage (manual init):
...
function createWidget(cfg) {
    ...
    function bubbleIcon() {
        if (!cfg.iconUrl) return ICONS.chat;
        return `<img src="${cfg.iconUrl}" style="position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover;" />`;
    }
